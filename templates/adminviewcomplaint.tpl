               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img">
                        <!-- <img class="img-responsive" src="admin/images/layout_img/user_img.jpg" alt="#" /> -->
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><!-- <img class="img-responsive rounded-circle" src="admin/images/layout_img/user_img.jpg" alt="#" /> -->
                                    ...
                                    <table class="table table-dark">
                                       ...
                                       {foreach from=$data item="d"}
                                          ...
                                          <td>{$d.contactno}</td>
                                             ...
                                             <td><a href="replycomplaint.php?a={$d.complaintkey}" class="btn btn-success">Reply</a></td>
                                          </tr>
                                    ...
                                    <table class="table">
                                       ...
                                       {foreach from=$data item="d"}
                                          <tr>
                                             ...
                                             <td><a href=".php?a={$d.crimekey}" class="btn btn-success">UploadCrimehistory</a></td>
                                          </tr>
                                          <tr>
 -->                                             <!-- <td>July</td>
                                             <td>Dooley</td>
                                    ...
                                    <table class="table">
                                       ...
                                       {foreach from=$data item="d"}
                                          <tr>
                                             ...
                                             <td><a href="policeapprove.php?a={$d.loginid}" class="btn btn-success">approve</a></td>
                                             <td><a href="policereject.php?r={$d.loginid}" class="btn btn-danger">reject</a></td> 
                                             {
                                             elseif $d.status==1
                                             }
                                             <td>approved</td>
