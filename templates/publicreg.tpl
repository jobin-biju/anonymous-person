...
<body>
	...
	<tr><td>Fullname</td><td><input type="text" name="fullname" class="form-control" ></td></tr>
	...
	<tr><td>Aadharno</td><td><input type="text" name="aadharno" class="form-control"></td></tr>
	<tr><td>Contactno</td><td><input type="text" name="contactno" class="form-control"></td></tr>
