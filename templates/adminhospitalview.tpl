                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="admin/images/layout_img/user_img.jpg" alt="#" /><span class="name_user">ADMIN</span></a>
                                    ...
                                    <table class="table">
                                       ...
                                       {foreach from=$data item="d"}
                                          <tr>
                                             ...
                                             <td><a href="hospitalapprove.php?a={$d.loginid}" class="btn btn-success">approve</a></td>
                                             <td><a href="hospitalreject.php?r={$d.loginid}" class="btn btn-danger">reject</a></td> 
                                             {
                                             elseif $d.status==1
                                             }
                                             <td>approved</td>
