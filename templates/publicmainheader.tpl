        ...
        <nav id="primary-navigation" class="site-navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="site-title"><span>Anoymous</span>Person</a>
                ...
                <div class="collapse navbar-collapse" id="agency-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">ENQUIRY<i class="fa fa-caret-down hidden-xs" aria-hidden="true"></i></a>

                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                            <li><a href="enquiryreg.php"> enquiry</a></li>
                              <li><a href="enquirypublicview.php">view enquiry</a></li>
                              <!-- <li><a href="blog.html">Blog</a></li> -->
                            </ul>

                        </li>
                        <li><a href="publicregedit.php">PROFILE</a></li>

                        <li class="dropdown"><a href=".php" class="dropdown-toggle" data-toggle="dropdown">MISSING PERSON<i class="fa fa-caret-down hidden-xs" aria-hidden="true"></i></a>

                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                              <li><a href="missingperson.php">Missing Person</a></li>
                              <li><a href="publicmissingview.php">View missing person</a></li>
                               <li><a href="status1.php">Missing list</a></li> 
                            </ul>
                     ...
                     <!--    <li><a href="missingperson.php">Missing Person</a></li>
                        <li><a href="publicmissingview.php">View missing person</a></li>
                        <li><a href="status1.php">Missing list</a></li> -->
                         <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">ACCIDENT <i class="fa fa-caret-down hidden-xs" aria-hidden="true"></i></a>

                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                              <!-- <li><a href="missingperson.php">Missing Person</a></li> -->
                              <li><a href="accidentreg.php"> Register Accident</a></li>
                        <li><a href="accidentregedit.php"> View Accident</a></li></ul></li>

                        <li class="dropdown"><a href=".php" class="dropdown-toggle" data-toggle="dropdown">CASES<i class="fa fa-caret-down hidden-xs" aria-hidden="true"></i></a>

                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                            <li><a href="casereg.php">Register cases</a></li>
                              <li><a href="caseregview.php">View cases</a></li></ul>
                               <li class="dropdown"><a href=".php" class="dropdown-toggle" data-toggle="dropdown">COMPLAINTS<i class="fa fa-caret-down hidden-xs" aria-hidden="true"></i></a>

                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                            <li><a href="complaint.php">Register complaints</a></li>
                              <li><a href="complaintview.php">View complaints</a></li></ul>
