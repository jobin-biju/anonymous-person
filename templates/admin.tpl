...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img">
                        <!-- <img class="img-responsive" src="admin/images/layout_img/user_img.jpg" alt="#" /></div> -->
                        <div class="user_info">
                           <h6>ADMIN</h6>
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html">
                           <img class="img-responsive" src="admin/images/logo/logo.png" alt="#" /></a>
                        </div>
      ...
      <!-- <img class="img-responsive rounded-circle" src="admin/images/layout_img/user_img.jpg" alt="#" /> -->
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h3>Anonymous Person Finding</h3>
                              <br>
                              <br>
                              <p>Anonymous person finding is a web based system.A missing person is a person who has disappeared and whose status as alive or dead cannot be confirmed as their location and fate are not known.Here the system will help to find the anonymous body with the help of modern pattern matching algorithm.This algorithm search the similarity in postmortem reports and crime reports any person can upload the missing details of the person to the corresponding area nd it will display all matching history with minute seconds.
                              </center>
                              </p>
                           </div>
                        </div>
