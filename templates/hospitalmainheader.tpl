                ...
                <div class="collapse navbar-collapse" id="agency-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="index.php" data-toggle="dropdown">HOME</a></li>
                              <li><a href="hospitalregedit.php"> PROFILE</a></li>

                        <li class="dropdown"><a href=".php" class="dropdown-toggle" data-toggle="dropdown">CASESHEET <i class="fa fa-caret-down hidden-xs" aria-hidden="true"></i></a>

                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                            <li><a href="casesheet.php"> casesheet</a></li>
                              <li><a href="casesheetview.php">View casesheet</a></li>
                              <!-- <li><a href="enquiryview.php">View Enquiry </a></li> -->
                            </ul>
                        ...
                        <li class="dropdown"><a href=".php" class="dropdown-toggle" data-toggle="dropdown">ENQUIRY <i class="fa fa-caret-down hidden-xs" aria-hidden="true"></i></a>
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                               <li><a href="enquiryview.php"">Public enquiry</a></li> 
                              <li><a href="policeenquiryhospitalview.php">Police enquiry</a></li>
                               </ul>
                              <li><a href="postmortemrqstview.php">POSTMORTEM REQUEST</a></li>
                              <li><a href="messageview.php">MESSAGE</a></li>

                        </li>
                        <!-- <li><a href="casesheet.php">Casesheet adding</a></li> -->
                       <!--  <li><a href="enquiryview.php"">Public enquiry</a></li> -->
