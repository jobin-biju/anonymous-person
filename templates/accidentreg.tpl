...
<body>
	...
	<tr><td>Street</td><td><input type="text" name="street" class="form-control"></td></tr>
	<tr><td>Pincode</td><td><input type="text" name="pincode" class="form-control"></td></tr>
	<tr><td>Accident details</td><td><textarea name="accidentdetails" class="form-control"></textarea></td></tr>
